...
if(isset($_REQUEST['btn_insert']))
{
	try
	{
		...
		{
			$errorMsg="Upload DOCX File Format.....CHECK FILE EXTENSION"; //error message file extension
		}

		if(!isset($errorMsg))
		{
			$insert_stmt=$db->prepare('INSERT INTO tbl_asses(name,file,course) VALUES(:fname,:fimage,:fcourse)'); //sql insert query
								 ...
								 <div class="row">
										 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												 <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
														 ...
														 <li><a href="index.php"><i class="notika-icon notika-file"></i> View Assignments</a>
														 </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                      ...
                      <div class="basic-tb-hd">
                          <h2 class="text-center">Upload Assignments</h2>
                      </div>
<br>
                      <div class="wrapper">
