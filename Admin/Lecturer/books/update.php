...
if(isset($_REQUEST['btn_update']))
{
	try
	{
		...
		if($image_file)
		{
			...
			{
				$errorMsg="Upload only PDF Files.....CHECK FILE EXTENSION"; //error message file extension
			}
		}
		else
		{
		...
		if(!isset($errorMsg))
		{
			$update_stmt=$db->prepare('UPDATE tbl_books SET name=:name_up, image=:file_up WHERE id=:id'); //sql update query
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="data-table-list">
						...
						<div class="basic-tb-hd">
							<h2 class="text-center">Update References</h2>
						</div>
						<br>
						<div class="wrapper">
							...
							<div class="container">
								...
								<div class="col-lg-12">
									...
									<form method="post" class="form-horizontal" enctype="multipart/form-data">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">New Ref File</label>
											<div class="col-sm-6">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Previous Ref File</label>
											<div class="col-sm-6">
												<p><?php echo $image; ?></p>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-sm-offset-3 col-sm-9 m-t-15">
												<button type="submit"  name="btn_update" class="btn btn-info btn-md">Update</button>
