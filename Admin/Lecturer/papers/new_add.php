...
if(isset($_REQUEST['btn_insert']))
{
  try
  {
    ...
    if(!isset($errorMsg))
    {
      $insert_stmt=$db->prepare('INSERT INTO tbl_papers(name,file,course) VALUES(:fname,:fimage,:fcourse)'); //sql insert query
...
<head>
  ...
  <title>Upload a Past paper</title>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
            ...
            <li><a href="index.php"><i class="notika-icon notika-file"></i> View Past papers</a>
            </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="data-table-list">
            ...
            <div class="basic-tb-hd">
              <h2 class="text-center">Upload a Past Paper</h2>
            </div>
            <br>
            <div class="wrapper">
                  ...
                  <form method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" name="txt_name" class="form-control" placeholder="Enter Details" />
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-sm-3 control-label">File (only Zip)</label>
                        <div class="col-sm-6">
