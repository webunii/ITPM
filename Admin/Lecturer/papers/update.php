...
if(isset($_REQUEST['update_id']))
{
	try
	{
		...
		$select_stmt = $db->prepare('SELECT * FROM tbl_papers WHERE id =:id'); //sql select query
...
if(isset($_REQUEST['btn_update']))
{
 ...
 else
 {
	$image_file=$row['file']; //if you not select new image than previous image sam it is it.
		...
		if(!isset($errorMsg))
		{
			$update_stmt=$db->prepare('UPDATE tbl_papers SET name=:name_up, file=:file_up WHERE id=:id'); //sql update query
...
<head>
    ...
    <title>Update the Past paper</title>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                      ...
                      <div class="basic-tb-hd">
                          <h2 class="text-center">Update the Past paper</h2>
                      </div>
                      <br>
                      <div class="wrapper">
